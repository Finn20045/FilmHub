"""
Django settings for KSP7Form project.
...
SECRET_KEY = 'django-insecure-52@d=4fae*3)*%c$gh0m%h!+x2o0wx=lkd(l#5yasuvwczafkl'
...
SESSION_COOKIE_SECURE = False  # Важно для http (не https)
